...
<div class="wrap">
    ...
    */
    ...
    <small style="margin-left:10px;"><?php _e("Updates translation in progress with new style identifiers for documents. The new identifiers depend on the document being translated and the languages so it's not possible to get out of sync when translations are being deleted locally.", 'sitepress') ?></small>
    </p>
    <?php endif; ?>
    <p>
